                    ...
                    <form action="{{ route('recipe.update',$recipe) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="flex gap-2">
                            ...
                            <div class="mb-4 w-3/4">
                                <label for="recipeTitle" class="block text-gray-700 font-medium mb-1">
                                    Recipe Name:</label>
                                <input id="title" type="text" name="recipeTitle" value="{{ $recipe->title }}"
                        ...
                        <div class="flex gap-2">
                            ...
                            <div class="mb-4 w-3/4">
                                ...
                                <textarea id="description" name="short_description" placeholder="Short Description"
                                    class="w-full border border-gray-300 rounded px-3 py-2 focus:ring focus:ring-blue-300 focus:outline-none transition duration-300 ease-in-out summernote @error('short_description') border-red-500 @enderror">{{ $recipe->short_description }}</textarea>
                        ...
                        <div class="flex gap-2">
                            ...
                            <div class="mb-4 w-2/12">
                                <label for="pre_time" class="block text-gray-700 font-medium mb-1">
                                    Pre Time:</label>
                                <input type="text" id="pre_time" name="pre_time" placeholder="Pre Time" value="{{ $recipe->pre_time }}"
                            ...
                            <div class="mb-4 w-2/12">
                                ...
                                <input type="text" id="cook_time" name="cook_time" placeholder="Cook Time" value="{{ $recipe->cook_time }}"
                            ...
                            <div class="mb-4 w-8/12">
                                <label for="pre_time" class="block text-gray-700 font-medium mb-1">
                                    Video Link:</label>
                                <input id="video_link" name="video_link" placeholder="Video Link" value="{{ $recipe->video_link }}"
                        ...
                        <div>
                            <label for="nutrition_text" class="block text-gray-700 font-medium mb-1">Nutrition
                                Text</label>
                            <textarea name="nutrition_text" id="nutrition_text" cols="5" rows="2" class="px-2 py-3 rounded w-full pt-2 border-gray-300 focus:ring focus:ring-blue-300 focus:outline-none transition duration-300 ease-in-out @error('nutrition_text') border-red-500 @enderror">{{ $recipe->nutrition_text }}</textarea>
                        ...
                        <!-- Submit Button -->
                        <div class="mt-6">
                            <button type="submit" class="add-new-btn flex gap-2 align-middle py-2">
                            <x-edit-icon/> Update Recipe
                            </button>
                        </div>
                    </form>
                </div>
