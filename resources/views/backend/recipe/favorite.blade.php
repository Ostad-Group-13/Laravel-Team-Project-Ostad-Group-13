<x-app-layout>
    ...
    <div class="bg-white  py-3 px-5 rounded-lg">
        ...
        <h2 class="text-blue-600 font-semibold text-lg px-1 pt-3">Total Favorite Recipe List {{ count($user['favoriteRecipes']) }}</h2>
        <div class="py-4">
                ...
                <table class="min-w-full leading-normal">
                    <thead class="bg-blue-500 text-white font-semibold text-lg">
                        <tr>
                            ...
                            <th class="px-5 py-3 text-left uppercase tracking-wider border-r border-r-blue-600">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($user['favoriteRecipes'] as $recipe)
                           <tr>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm border-r border-r-gray-300">
                                {{ $loop->index + 1 }}</td>
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm border-r border-r-gray-300">
                                <div class="flex">
                            ...
                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm border-r border-r-gray-300">
                             ...
                             <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm border-r border-r-gray-300">
                                ...
                                <a href="" class="px-2 py-2 rounded transition duration-300 ease-linear border-2 border-blue-600 hover:bg-blue-500  text-lg hover:text-white">Show</a>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-5 py-5 border-b border-gray-200 bg-white text-sm border-r border-r-gray-300 text-center">
