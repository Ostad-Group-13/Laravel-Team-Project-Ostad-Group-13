        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-8">
          ...
          <div class="w-full lg:w-2/3 space-y-6">
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <img src="images/img11111.png" alt="Noodle Recipe" class="w-full lg:w-1/3 rounded-lg object-cover">
                ...
                <div class="flex items-center gap-2 text-sm text-gray-500 mt-8">
                  <span>
                    <img class="rounded-full user-profile-img" src="/images/user-img.png" alt="">
                  </span>
          ...
          <div class="w-full lg:w-1/3">
            ...
            <div class="space-y-6">
              ...
              <div class="flex gap-4">
                <img src="images/img11111.png" alt="Recipe 1" class="pagination-btn rounded-lg object-cover">
                <div>
              ...
              <!-- Recipe 2 -->
              <div class="flex gap-4">
                <img src="images/img11111.png" alt="Recipe 2" class="pagination-btn rounded-lg object-cover">
                <div>
                  <h4 class="text-lg mt-2 font-medium">Chicken Meatballs with Cream Cheese</h4>
                  <p class="text-sm mt-3 text-gray-500">By Andreas Paula</p>
                </div>
              ...
              <!-- Recipe 3 -->
              <div class="flex gap-4">
                <img src="images/img11111.png" alt="Recipe 3" class="pagination-btn rounded-lg object-cover">
                <div>
                  <h4 class="text-lg mt-2 font-medium">Chicken Meatballs with Cream Cheese</h4>
                  <p class="text-sm mt-3 text-gray-500">By Andreas Paula</p>
                </div>
