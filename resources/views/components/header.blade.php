  ...
  <header class="header_area py-[40px] border-b border-[#0000001A]">
              ...
              <div class="main_menu hidden lg:block">
                  <nav>
                      <ul class="flex items-center gap-3">
                          ...
                          <li><a href="{{ url('/') }}"
                                  class="border-b-2 hover:border-b-blue-800 font-medium text-xs px-2 py-3 transition-all duration-300 ease-in-out">Home</a>
                          </li>
                          <li><a href="{{ route('recipesPage') }}"
                                  class="border-b-2 hover:border-b-blue-800 font-medium text-xs px-2 py-3 transition-all duration-300 ease-in-out">Recipes</a>
                          </li>
                          <li><a href="{{ route('aboutPage') }}"
                                  class="border-b-2 hover:border-b-blue-800 font-medium text-xs px-2 py-3 transition-all duration-300 ease-in-out">About
                                  us</a></li>
                          <li><a href="{{ route('blogPage') }}"
                                  class="border-b-2 hover:border-b-blue-800 font-medium text-xs px-2 py-3 transition-all duration-300 ease-in-out">Blog</a>
                          </li>
                          <li><a href="{{ route('contactPage') }}"
                                  class="border-b-2 hover:border-b-blue-800 font-medium text-xs px-2 py-3 transition-all duration-300 ease-in-out">Contact</a>
                          </li>
                      </ul>
                  </nav>
              </div>
      ...
      <!-- Overlay -->
      <div id="overlay" class="fixed inset-0 bg-black opacity-0 pointer-events-none transition-opacity duration-300">
      </div>

      <!-- Mobile Menu -->
      <div id="mobile_menu"
          class="fixed top-0 right-0 w-[300px] h-full bg-white transform translate-x-full transition-transform duration-300 ease-in-out lg:hidden shadow-lg">
