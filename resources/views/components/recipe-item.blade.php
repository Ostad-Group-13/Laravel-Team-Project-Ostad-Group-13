<div class="racipe_item">
    ...
    <div class="recipe_content py-[24px] px-[10px]">
        <a href="{{ route('recipes.show', $recipe->slug) }}">
            <h3 class="recipe_title mb-[24px]">{{ $recipe->title }}</h3>
        </a>
        <div class="flex items-center gap-6">
            <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-medium text-[#00000099]">{{ $recipe->cook_time }} {{ 'Minutes' }}</span>
            </div>
            <div class="flex items-center gap-2">
                <div class="icon">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                ...
                <span class="text-sm font-medium text-[#00000099]">{{ $recipe->category->name }}</span>
            </div>
        </div>
    </div>
</div>
