...
<x-app-layout>
    ...
    {{-- <div id="loading-spinner" class="loading-spinner animate-spin" style="display: none;">
        Loading...
    </div> --}}

    <div id="loading-spinner" role="status" style="display: none;">
        <svg aria-hidden="true"
            class="inline w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 transition-all duration-300 ease-in-out"
                ...
                <div class="px-2">
                    ...
                    @auth
                        <button id="favorite-btn-{{ $recipe->id }}"
                            class="favorite-btn bg-green-500 px-2 py-2 text-center text-lime-50 rounded-lg"
