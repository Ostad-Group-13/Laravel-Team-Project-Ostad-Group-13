    ...
    <section class="slider_area py-[40px]">
      <div class="container">
        <div class="slider_wrapp">
          <div class="slider_itam flex lg:flex-row flex-col items-center justify-between bg-[#E7FAFE] w-full lg:h-[640px] h-full rounded-[50px] overflow-hidden relative py-20 lg:p-0">
            <div class="slider-crical-image hidden lg:block">
              <img src="{{ asset('/assets/img/sliders/Badge.png') }}" alt="">
            </div>
            <div class="content_area lg:w-1/2 w-full sm:px-[50px] px-[10px]">
              <div class="subtitle flex items-center gap-[10px] w-fit bg-white py-[10px] px-[20px] rounded-[30px] mb-[30px]"> <img src="./assets/img/sliders/subtitle-icon.png" alt=""><span class="text-sm font-semibold">Hot Recipes</span></div>
              <h1 class="xl:text-[64px] lg:text-[50px] text-[35px] font-semibold leading-tight mb-[20px]">Spicy delicious<br> chicken wings</h1>
              <p>Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqut enim ad minim </p>

              <div class="flex items-center gap-[20px] mt-[30px] mb-[30px]">
                <div class="flex items-center gap-[10px] w-fit px-[20px] py-[8px] bg-[#0000000D] rounded-[30px]">
                  <div class="icon">
              ...
              <div class="flex xl:flex-row flex-col xl:items-center items-start xl:justify-between justify-start mt-[60px]">
            ...
            <div class="image_area lg:w-1/2 h-full w-full hidden lg:block ">
              <img class="w-full h-full object-cover" src="{{ asset('/assets/img/sliders/slider01.jpg') }}" alt="slider-img">
            </div>
          </div>
        </div>
      </div>
