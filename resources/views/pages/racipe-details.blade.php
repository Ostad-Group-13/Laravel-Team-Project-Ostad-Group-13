<x-guest-layout>
    ...
    <div class="container">
      <div class="racipe_details_wrapp flex flex-col lg:flex-row gap-[40px] items-center">
        <div class="rd_head_info lg:w-2/3 w-full">
          <h1 class="xl:text-[64px] md:text-[50px] text-[35px] font-semibold text-black">Health Japanese Fried Rice</h1>
          <div class="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-[20px] items-center py-[50px]">
            <div class="rd_head_info_item">
              <div class="flex items-center gap-[16px]">
                <img src="./assets/img/sliders/auther01.png" alt="">
                <div class="flex flex-col">
                  <span class="font-medium text-sm">Micheal Smith</span>
                  <p class="text-[#00000099] text-sm font-medium">15 March 2022</p>
                </div>
              </div>
            </div>
            <div class="rd_head_info_item">
              <div class="flex items-center sm:justify-center justify-start gap-[10px]">
                ...
                <div class="flex flex-col">
                  ...
                  <p class="text-[#00000099] text-sm font-medium">15 Minutes</p>
                </div>
              </div>
            </div>
            <div class="rd_head_info_item">
            ...
            <div class="rd_head_info_item">
              <div class="flex items-center sm:justify-center justify-start gap-[10px]">
                ...
                <div class="flex flex-col">
                  <span class="font-medium text-sm">Chicken</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="image_and_Nutrition flex flex-col lg:flex-row gap-[40px] justify-between">
        <div class="image lg:w-2/3 w-full">
          ...
          <div class="relative w-full max-w-4xl mx-auto h-64 sm:h-80 md:h-[400px] lg:h-[600px] rounded-[30px] shadow-lg overflow-hidden bg-white">
            <!-- Preview Image -->
            <img id="video-preview" 
                 src="./assets/img/racipes/rd01.jpg" 
                 alt="Video Preview" 
            ...
            <video class="hidden w-full object-cover max-w-4xl mx-auto h-64 sm:h-80 md:h-[400px] lg:h-[600px]" id="video-iframe" Controls src="./assets/img/racipes/racipe-video01.mp4"></video>
        ...
        <div class="nutrition_info lg:w-1/3 w-full">
          <div class="nutrition grid">
              <div>
                ...
                <ul class="mt-[30px]">
                  <li><span >Calories</span> <span class="nu_value">200 kcal</span></li>
                  <li><span >Total Fat</span> <span class="nu_value">200 kcal</span></li>
                  <li><span >Protein</span> <span class="nu_value">200 kcal</span></li>
                  <li><span >Carbohydrate
                  </span> <span class="nu_value">200 kcal</span></li>
                  <li><span >Cholesterol</span> <span class="nu_value">200 kcal</span></li>
                </ul>
              </div>
              <p class="text-center self-end">adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
          </div>
        </div>
        ...
        <div class="ingridents lg:w-2/3 w-full">
         ...
         <div class="description mt-6">
          ...
          <div class="desc-content">
            <h3 class="text-[24px] font-semibold mb-4"><span>1. </span>Lorem ipsum dolor sit amet </h3>
            <p class="pb-10">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
            <div class="post_content_img">
              <img class="w-full" src="./assets/img/racipes/rd02.jpg" alt="">
            </div>
            <p class="py-10">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
            <hr>

            <h3 class="text-[24px] font-semibold mt-10"><span>2. </span>Lorem ipsum dolor sit amet </h3>
            <p class="pt-5 pb-10">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
            <hr>

            <h3 class="text-[24px] font-semibold mt-10"><span>3. </span>Lorem ipsum dolor sit amet </h3>
            <p class="pt-5 pb-10">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
            <hr>
          </div>
            ...
            <div class="space-y-4">
              ...
              <div class="flex gap-4 items-center">
                <div class="sm:w-[180px] sm:h-[120px] w-[100px] h-[80px] flex-shrink-0">
                  <img src="./assets/img/racipes/siderc.jpg" alt="Chicken Meatball" class="w-full h-full object-cover rounded-lg">
                </div>
                <div>
                  <h3 class="font-semibold sm:text-[20px] text-[16px] leading-tight sm:leading-[28px]">Chicken Meatball with Creamy Chees...</h3>
  ...
  <script>
    ...
    playButton.addEventListener('click', () => {
        ...
        videoIframe.src = "./assets/img/racipes/racipe-video01.mp4";
    });
</script>
