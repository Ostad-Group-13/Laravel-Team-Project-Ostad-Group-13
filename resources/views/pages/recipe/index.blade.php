    ...
    <div class="container">
        <div class="flex flex-col lg:flex-row gap-[30px]">
                ...
                <form id="filter-form">
                        ...
                        <ul class="filter_list">
                            @foreach ($allCategories as $category)
                                <li class="filter_list_item">
                                    <label>
                                        <input class="filter_recipe" type="checkbox" name="categories[]" value="{{ $category->id }}">
                                        {{ $category->name }}
                                    </label>
                                </li>
                            @endforeach
                    ...
                    <div class="filter_item mb-[30px]">
                      ...
                      <div class="flex gap-[10px]">
                          <input type="number" min="1" name="cook_time_min" placeholder="Min" class="filter_recipe form-input w-1/2" value="{{ request('cook_time_min') }}">
                          <input type="number" min="1" name="cook_time_max" placeholder="Max" class="filter_recipe form-input w-1/2" value="{{ request('cook_time_max') }}">
                      </div>
                    </div>
            ...
            <div class="racipe_content relative lg:w-4/5 w-full">
                ...
                <div id="no-recipes-found" class="hidden absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
