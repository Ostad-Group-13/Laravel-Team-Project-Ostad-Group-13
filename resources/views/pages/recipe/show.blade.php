<x-guest-layout>
            ...
            <div class="rd_head_info_item">
              <div class="flex items-center sm:justify-center justify-start gap-[10px]">
                ...
                <div class="flex flex-col">
                  ...
                  <p class="text-[#00000099] text-sm font-medium">{{ $recipe->pre_time }} {{ 'Minutes' }}</p>
                </div>
              </div>
            </div>
            <div class="rd_head_info_item">
              <div class="flex items-center lg:justify-center justify-start gap-[10px]">
                ...
                <div class="flex flex-col">
                  ...
                  <p class="text-[#00000099] text-sm font-medium">{{ $recipe->cook_time }} Minutes</p>
                </div>
              </div>
            </div>
            <div class="rd_head_info_item">
  ...
  @livewire('comments', ['recipe_id' => $recipe->id])
